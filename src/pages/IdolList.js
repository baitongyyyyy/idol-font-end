...
import { Container, Row, Col, Card, Button, Table, Dropdown, OverlayTrigger, Popover } from 'react-bootstrap';
import { connect } from 'react-redux';
import { MdStar, MdMoreHoriz, MdMoreVert, MdControlPoint, MdImportExport } from "react-icons/md";
import { addModal, checkLogin, addLogin, modalSale } from '../redux/actions';
...
class IdolList extends Component {
    ...
    ChangeSaleModal = async (value,id) => {
        this.props.opensaleModal(value,id);
    }
    ...
    //                 <a href="/edit-idol" className="point3" target="_blank">
    //                     <h6>Edit</h6>
    //                 </a>
    //                 <h6 className="point3">Approve</h6>
    //                 <h6 onClick={() => this.ChangeSaleModal(true,id)} className="point3">Change sale</h6>
    //                 <h6 className="point3">Manage product</h6>
    //                 <h6 className="point3">Delete</h6>
    //             </Popover.Content>
    //         </Popover>
    //     )
    // }
        ...
        const popover = (
            <Popover id="popover-basic">
                ...
                <Popover.Content className="w-pop">
                    ...
                    <h6 className="point3">Approve</h6>
                    <h6 onClick={() => this.ChangeSaleModal(true)} className="point3">Change sale</h6>
                    <h6 className="point3">Manage product</h6>
                    <h6 className="point3">Delete</h6>
                </Popover.Content>
            </Popover>
